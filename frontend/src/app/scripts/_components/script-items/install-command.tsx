...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/Sciruss/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.Sciruss.org/Sciruss/${basePath}/raw/branch/main/${scriptPath}`;
