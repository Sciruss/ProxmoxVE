...
service:
  ...
  Sciruss/ProxmoxVE:
    latest_version:
      type: github
      url: Sciruss/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/Sciruss/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/Sciruss/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
